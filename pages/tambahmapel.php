...
<?php
    ...
    {
        $sql = "INSERT INTO tblmapel VALUES ('','$mapel','$semester','$sks','$ket')";
        $result = mysqli_query($connect,$sql);
    }
    header("location:tambahmapel.php");
?>
            <!-- Vertical Layout -->
                        ...
                        <div class="body">
                            <form action="tambahmapel.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="mapel" id="mapel" placeholder="Masukkan Mata Pelajaran" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="sks" id="sks" placeholder="Masukkan jumlah sks" required>
                                    </div>
                                </div>
                                ...
                                <a class="btn btn-warning waves-effect" href="mapel.php">KEMBALI</a>
                            </form>
                        </div>
                    </div>
                </div>
