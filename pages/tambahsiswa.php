...
<?php
    ...
    {
        $sql = "INSERT INTO tblSiswa VALUES ('$nis','$nama','$jk','$tempatLahir','$tglLahir','$nomorTelp','$alamat')";
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="tambahSiswa.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tempatLahir" id="tempatLahir" placeholder="Masukkan tempat lahir" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nomorTelp" id="nomorTelp" placeholder="Masukkan nomor telepon" required>
                                    </div>
                                </div>
                                <label for="alamat">Alamat</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control no-resize" placeholder="Masukkan alamat" required></textarea>
                                    </div>
                                </div>
                                <br>
                                <button type="submit" class="btn btn-primary waves-effect">SIMPAN</button>
                                <button type="reset" class="btn btn-danger waves-effect">BATAL</button>
                                <a class="btn btn-warning waves-effect" href="Siswa.php">KEMBALI</a>
                            </form>
                        </div>
                    </div>
                </div>
