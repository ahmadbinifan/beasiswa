                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="tambahmapel.php">Tambah Data</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo $myrow['semester'] ?></td>
                                            <td><?php echo $myrow['sks'] ?></td>
                                            <td><?php echo $myrow['ket'] ?></td>
                                            <td>
                                                <a class="btn-danger btn waves-effect" href="editmapel.php?id=<?php echo $myrow['idmapel']; ?>">Edit</a>
                                                <a class="btn btn-warning waves-effect" href="hapusmapel.php?id=<?php echo $myrow['idmapel']; ?>"onclick="return confirm('Apakah anda yakin ingin menghapus data ini ??');">Hapus</a>
                                            </td>
                                        </tr>
<?php
        $nomor=$nomor+1;
