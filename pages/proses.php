...
<?php
    $nomor = 1;
    $sql = "SELECT *, tblPenilaian.ket FROM tblPenilaian INNER JOIN tblsiswa ON tblPenilaian.nis=tblsiswa.nis INNER JOIN tblmapel ON tblPenilaian.idmapel=tblmapel.idmapel";
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo $myrow['nilai1'] ?></td>
                                            <td><?php echo $myrow['nilai2'] ?></td>
                                            <td><?php echo $myrow['nilai3'] ?></td>
                                            <td><?php echo $myrow['nilai4'] ?></td>
                                            <td><?php echo $myrow['nilai5'] ?></td>
                                            <td><?php echo $myrow['nilai6'] ?></td>
                                            <td><?php echo $myrow['ket'] ?></td>
                                            <td>
                                                <a class="btn-danger btn waves-effect" href="editProses.php?id=<?php echo $myrow['idNilai']; ?>">Edit</a>
                                                <a class="btn btn-warning waves-effect" href="hapusProses.php?id=<?php echo $myrow['idNilai']; ?>"onclick="return confirm('Apakah anda yakin ingin menghapus data ini ??');">Hapus</a>
                                            </td>
                                        </tr>
<?php
        $nomor=$nomor+1;
