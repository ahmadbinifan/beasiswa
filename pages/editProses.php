<?php
    ...
    $kode = $_GET['id'];
    $sql = "SELECT *, tblPenilaian.ket FROM tblPenilaian INNER JOIN tblsiswa ON tblPenilaian.nis=tblsiswa.nis INNER JOIN tblmapel ON tblPenilaian.idmapel=tblmapel.idmapel "."WHERE idNilai='$kode'";
                        ...
                        <div class="body">
                            <form action="updateProses.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="id" value="<?php echo $myrow['idNilai'] ?>">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="mapel" id="mapel" value="<?php echo $myrow['mapel'] ?>" readonly>
                                    </div>
                                </div>
                                <label for="">Nama</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $myrow['nama'] ?>" readonly>
                                    </div>
                                </div>
                                <label for="">Absensi</label>
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai1">
                                        <option><?php echo $myrow['nilai1'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                        <option value="40">Sangat Kurang [40]</option>
                                    </select>
                                </div>
                                <label for="">Tugas</label>
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai2">
                                        <option><?php echo $myrow['nilai2'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                ...
                                <label for="">UTS</label>
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai3">
                                        <option><?php echo $myrow['nilai3'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                ...
                                <label for="">UAS</label>
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai4">
                                        <option><?php echo $myrow['nilai4'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                ...
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai5">
                                        <option><?php echo $myrow['nilai5'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                ...
                                <div class="form-group">
                                    <select class="form-control show-tick" name="nilai6">
                                        <option><?php echo $myrow['nilai6'] ?></option>
                                        <option value="100">Sangat Baik [100]</option>
                                        <option value="80">Baik [80]</option>
                                        <option value="60">Cukup [60]</option>
                                        <option value="50">Kurang [50]</option>
                                ...
                                <a class="btn btn-danger waves-effect" href="proses.php">BATAL</a>
                            </form>
                        </div>
                    </div>
                </div>
